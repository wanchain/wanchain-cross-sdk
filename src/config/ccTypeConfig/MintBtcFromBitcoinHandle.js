...
module.exports = class MintBtcFromBitcoinHandle {
  ...
  async process(tokenPairObj, convertJson) {
    ...
    try {
      console.log("MintBtcFromBitcoinHandle tokenPairObj:", tokenPairObj);
      console.log("MintBtcFromBitcoinHandle convertJson:", convertJson);
      ...
      console.log("MintBtcFromBitcoinHandle fee:", fees, networkFee);
      ...
      console.log("MintBtcFromBitcoinHandle err:", err);
