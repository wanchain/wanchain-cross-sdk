...
module.exports = class MintWanFnxErc20 {
  ...
  async process(tokenPairObj, convertJson) {
    console.log("MintWanFnxErc20 tokenPairObj:", tokenPairObj);
    console.log("MintWanFnxErc20 convertJson:", convertJson);
    ...
    console.log("MintWanFnxErc20 tokenBalance:", tokenBalance);
    let balance = new BigNumber(tokenBalance);
    if (balance.isLessThan(value)) {
      console.log("MintWanFnxErc20 2 tokenBalance:", balance, " <= value:", value);
    ...
    let erc20ApproveParaJson = {
      ...
      "erc20Addr": tokenPairObj.wanchainTokenAddr,// token Addr
      ...
      "spenderAddr": tokenPairObj.fromAccount,// poolAddr
      "taskType": "ProcessErc20Approve",
      "fee": new BigNumber(0)
    };

    let allowance = await this.checkErc20Allowance(tokenPairObj.fromChainType,
      tokenPairObj.wanchainTokenAddr,// tokenAddr
      convertJson.fromAddr,
      tokenPairObj.fromAccount,// pool Addr
      tokenPairObj.fromScInfo.erc20AbiJson);
    console.log("MintWanFnxErc20 allowance:", allowance);
    ...
    let userErc20FastMintParaJson = {
      ...
      "taskType": "ProcessWanFnxErc20UserFastMint",
      "fee": fees.burnFeeBN,
      "userBurnFee": userBurnFee.originFeeBN,
      "wanchainTokenAddr": tokenPairObj.wanchainTokenAddr,// tokenAddr
      "tokenPairFromAccount": tokenPairObj.fromAccount,
      "tokenAccount": tokenPairObj.fromAccount,
      "tokenPairErc20Abi": tokenPairObj.fromScInfo.erc20AbiJson
    };
    ...
    if (await utilService.checkBalanceGasFee(retAry, tokenPairObj.fromChainType, convertJson.fromAddr, fees.burnFeeBN)) {
