...
module.exports = class MintLtcFromLitecoinHandle {
  ...
  async process(tokenPairObj, convertJson) {
    ...
    try {
      console.log("MintLtcFromLitecoinHandle tokenPairObj:", tokenPairObj);
      console.log("MintLtcFromLitecoinHandle convertJson:", convertJson);
      ...
      console.log("MintLtcFromLitecoinHandle fee:", fees, networkFee);
      ...
      let userFastMintParaJson = {
        ...
        "value": value,
        "taskType": "ProcessMintLtcFromLitecoin",
        "fee": fees.mintFeeBN,
      ...
      console.log("MintLtcFromLitecoinHandle err:", err);
