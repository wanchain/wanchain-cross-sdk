...
module.exports = class BurnWanFnxErc20 {
  ...
  async process(tokenPairObj, convertJson) {
    console.log("BurnWanFnxErc20 tokenPairObj:", tokenPairObj);
    console.log("BurnWanFnxErc20 convertJson:", convertJson);
    ...
    if (balance.isLessThan(value)) {
      console.log("BurnWanFnxErc20 2 tokenBalance:", balance, " <= value:", value);
    ...
    let userFastBurnParaJson = {
      ...
      "taskType": "ProcessWanFnxErc20UserFastBurn",
      "fee": fees.burnFeeBN,
    ...
    console.log("BurnWanFnxErc20 retAry:", retAry);
    ...
    if (await utilService.checkBalanceGasFee(retAry, tokenPairObj.toChainType, convertJson.fromAddr, fees.burnFeeBN)) {
      ...
      console.log("BurnWanFnxErc20 balance < gas");
      this.m_WebStores["crossChainTaskSteps"].setTaskSteps(convertJson.ccTaskId, []);
      return {
        stepNum: 0,
