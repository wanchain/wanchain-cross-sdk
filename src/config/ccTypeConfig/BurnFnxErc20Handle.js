...
module.exports = class BurnFnxErc20Handle {
  ...
  async process(tokenPairObj, convertJson) {
    ...
    // check erc20 token
    let tokenBalance = await this.m_iwanBCConnector.getTokenBalance(tokenPairObj.toChainType, convertJson.fromAddr, tokenPairObj.wanchainTokenAddr);
    ...
    let erc20ApproveParaJson = {
      ...
      "spenderAddr": tokenPairObj.toAccount,// poolAddr
    ...
    let allowance = await this.checkErc20Allowance(tokenPairObj.toChainType,
      ...
      tokenPairObj.toAccount,// spender poolAddr
    ...
    let userFastBurnParaJson = {
      ...
      "taskType": "ProcessFnxErc20UserFastBurn",
      "fee": fees.burnFeeBN,
      "tokenAccount": tokenPairObj.toAccount,
      //"tokenAccount": tokenPairObj.wanchainTokenAddr,
    ...
    if (await utilService.checkBalanceGasFee(retAry, tokenPairObj.toChainType, convertJson.fromAddr, fees.burnFeeBN)) {
      ...
      console.log("BurnFnxErc20Handle balance < gas");
      this.m_WebStores["crossChainTaskSteps"].setTaskSteps(convertJson.ccTaskId, []);
      return {
        stepNum: 0,
