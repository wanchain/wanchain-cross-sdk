...
class BurnErc20ProxyToken {
  ...
  async process(tokenPair, convert) {
    ...
    let allowance = await this.iwan.getErc20Allowance(chainInfo.chainType,
    ...
    if (allowance.isGreaterThan(0)) {
      if (allowance.isLessThan(value)) {
        // 1 approve 0
        let erc20Approve0ParaJson = Object.assign({}, erc20ApproveParas);
        erc20Approve0ParaJson.value = "0";
