...
class WanBridge extends EventEmitter {
  ...
  async init(iwanAuth, options = {}) {
    console.debug("SDK: init, network: %s, isTestMode: %s, smgName: %s, prefer: %s, ver: 2512121440", this.network, this.isTestMode, this.smgName, this.prefer);
