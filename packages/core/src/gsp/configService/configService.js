...
const abis = {
  ...
  "cctpProxy": require("../../config/abi/circleBridge/circleBridgeProxy.json"),
  "cctpTokenMessenger": require("../../config/abi/circleBridge/TokenMessenger.json"),
  "cctpMessageTransmitter": require("../../config/abi/circleBridge/MessageTransmitter.json"),
  "cctpV2Proxy": require("../../config/abi/circleBridge/cctpV2Proxy.json"),
  "cctpV2TokenMessenger": require("../../config/abi/circleBridge/TokenMessengerV2.json"),
  "cctpV2MessageTransmitter": require("../../config/abi/circleBridge/MessageTransmitterV2.json"),
